...
import { hexToRgb, rgbToHsl } from "../../content/colorUtils";
...
function ColorTools({ onBack }: ColorToolsProps) {
  ...
  const handleConverterChange = (newColor: string) => {
      ...
      <div className="p-5">
        ...
        <header className="mb-6 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-zinc-500">Pick and convert colors</p>
          </div>
        </header>
        ...
        {/* Converter */}
        <ColorConverter color={color} onColorChange={handleConverterChange} />

        {/* Footer */}
        <footer className="mt-6 border-t border-zinc-800 pt-4 text-center">
          <p className="text-xs text-zinc-600">WebToolKit Color Tools</p>
        </footer>
      </div>
    </main>
  );
